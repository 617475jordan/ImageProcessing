...
void action()
{
	...
	ReadImage(&ho_Image, "../data/2/box1.png");
	...
	SelectShape(ho_ConnectedRegions, &ho_SelectedRegions, "area", "and", 10000, 175000);
	...
	ReadImage(&ho_ImageSearch, "../data/2/box4.png");
	if (HDevWindowStack::IsOpen())
	...
	{
		float m_dAngle = hv_Angle[0].D() * 180 / 3.14;
		float m_dScore = hv_Score[0].D();
		float m_dCoordinate_X = hv_Column[0].D();
		float m_dCoordinate_Y = hv_Row[0].D();
		cout.precision(3);
		cout << "The coorindate is :(" << m_dCoordinate_X << "," << m_dCoordinate_Y << ")" << endl;
		cout << "The Angle is: " << m_dAngle << endl;
		cout << "The similarity is:" << m_dScore << endl;
	}
