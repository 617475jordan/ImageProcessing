...
void action()
{
	...
	OpenFramegrabber("File", 1, 1, 0, 0, 0, 0, "default", -1, "default", -1, "default",
		"..\\data\\2\\test1.png", "default", -1, 1, &hv_FGHandle);
	...
	HTuple hv_tmpFGHandle;
	HObject ho_tmpImg;
	OpenFramegrabber("File", 1, 1, 0, 0, 0, 0, "default", -1, "default", -1, "default",
		"..\\data\\2\\test2.png", "default", -1, 1, &hv_tmpFGHandle);
	GrabImage(&ho_tmpImg, hv_FGHandle);
	HTuple hv_tmpWidth, hv_tmpHeight;
	GetImageSize(ho_tmpImg, &hv_tmpWidth, &hv_tmpHeight);
	...
	if (HDevWindowStack::IsOpen())
		DispObj(ho_tmpImg, HDevWindowStack::GetActive());
	if (HDevWindowStack::IsOpen())
	...
	while (0 != (hv_Button != 1))
	{
		HDevWindowStack::SetActive(hv_WindowHandle);
		if (HDevWindowStack::IsOpen())
			SetPart(HDevWindowStack::GetActive(), 0, 0, hv_tmpWidth, hv_tmpHeight);
		...
		if (0 != ((hv_Score.TupleLength())>0))
		{
			...
			if (HDevWindowStack::IsOpen())
				SetPart(HDevWindowStack::GetActive(), 0, 0, 400, hv_tmpHeight - 1);
			if (HDevWindowStack::IsOpen())
